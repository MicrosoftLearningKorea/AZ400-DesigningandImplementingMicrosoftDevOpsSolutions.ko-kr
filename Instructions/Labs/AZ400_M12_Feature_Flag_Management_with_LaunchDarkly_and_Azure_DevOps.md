...
1. Visual Studio 창에서 **모두 저장**을 클릭한 다음 **IIS Express**를 클릭하여 애플리케이션을 로컬에서 시작합니다. **IIS Express** 옵션을 사용할 수 없는 경우에는 도구 모음에서 **Browser Link** 옵션을 선택하고 **Browser Link Dashboard**를 선택합니다. 대시보드에서 **View in browser**를 선택합니다. 
