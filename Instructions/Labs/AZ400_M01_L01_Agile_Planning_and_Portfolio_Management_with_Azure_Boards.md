...
1. 랩 컴퓨터의 브라우저 창에서 Azure DevOps 조직을 엽니다. **새 프로젝트**를 클릭합니다. 프로젝트에 **eShopOnWeb**이라는 이름을 지정합니다. **프라이빗**을 표시 유형 옵션으로 정의합니다.
...
1. 웹 브라우저가 이전 연습에서 생성한 **EShopOnWeb** 프로젝트와 함께 Azure DevOps organization 표시하는지 확인합니다.
...
3. **일반** 섹션에서 **Teams** 탭을 선택합니다. 이 프로젝트에는 **EShopOnWeb 팀에** 이미 기본 팀이 있지만 이 랩에 대한 새 팀을 만듭니다. **새 팀**을 클릭합니다.

    ![프로젝트 설정 창의 "팀" 탭에서 "새 팀" 클릭](images/m1/new_team_v1.png)

4. **새 팀 만들기** 창의 **팀 이름** 텍스트 상자에 **EShop-Web을** 입력하고 다른 설정을 기본값으로 두고 **만들기**를 클릭합니다.
...
6. **EShop-Web** 페이지 맨 위에 있는 **반복 및 영역 경로** 링크를 클릭하여 팀의 일정 및 scope 정의를 시작합니다.
...
8. **EShopOnWeb\Sprint 1**을 선택하고 **저장 후 닫기를** 클릭합니다. 이 첫 번째 스프린트는 반복 목록에 표시되지만 날짜는 아직 설정되지 않았습니다.
...
5. **영역** 항목 옆에 있는 **eShopOnWeb** 항목을 선택하고 드롭다운 목록에서 **EShop-WEB을** 선택합니다. 그러면 **영역** 이 **eShopOnWeb\EShop-WEB으로** 설정됩니다.
...
11. Azure DevOps 포털의 세로 탐색 창의 **Boards** 항목 목록에서 **보드**를 선택합니다.
12. **Boards** 패널에서 **EShop-WEB 보드** 항목을 선택합니다. 그러면 해당 팀의 보드가 열립니다.

    ![ "Boards>Boards" 창에서 "EShop-WEB 보드"를 선택합니다.](images/m1/EShop-WEB-_boards_v1.png)
...
19. **EShop-WEB** 패널의 **보드** 탭에서 고객으로서 라는 첫 번째 작업 항목을 끌어 새로 만들기에서 **승인됨** 단계로 **새 자습서를 보려고** 합니다.****
...
22. **EShop-WEB** 패널의 **보드** 탭에서 고객으로 라는 두 번째 작업 항목을 끌어서 최근에 **새로** 만들기에서 **커밋****된 단계로 본 자습서를 확인하려고** 합니다.
23. **EShop-WEB** 패널의 **보드** 탭에서 고객으로서 라는 세 번째 작업 항목을 끌어 새로 만들기 단계에서 완료 단계로 **새 자습서를 요청하려고** **합니다**.****

    ![이전 단계에서 지정된 열로 이동한 WIT](images/m1/EShop-WEB-board_pbis_v1.png)

    > **참고**: 작업 보드는 백로그를 확인할 수 있는 보기 중 하나입니다. 테이블 형식 보기를 사용할 수도 있습니다.

24. **EShop-WEB** 창의 **보드** 탭 창 위쪽에서 **백로그로 보기를** 클릭하여 테이블 형식 양식을 표시합니다.
...
25. **EShop-WEB** 창의 **백로그** 탭에서 창의 왼쪽 위 모서리에 있는 첫 번째 작업 항목 옆에 있는 위쪽의 두 번째 더하기 기호를 클릭합니다. 그러면 **새 작업** 창이 표시됩니다.
...
2. **스프린트** 보기 **작업 보드** 탭의 도구 모음 오른쪽에서 깔때기 아이콘 바로 왼쪽에 있는 **보기 옵션** 기호를 선택하고 **보기 옵션** 드롭다운 목록에서 **작업 세부 정보** 항목을 선택합니다.
    ...
    !["Boards">"Sprints" 창에서 "EShop-WEB" 팀에서 "옵션 보기" 아이콘을 선택하고 "작업 세부 정보"를 클릭합니다.](images/m1/EShop-WEB-work_details_v1.png)
...
10. **스프린트** 보기의 **태스크보드** 탭에서 **가장 최근 자습서의 추가 페이지를** 나타내는 정사각형 상자에서 이전 단계에서 식별한 이 스프린트의 총 용량과 일치하도록 예상 시간 수를 **14**로 설정합니다.
...
이 작업에서는 스크럼 기반 프로세스를 만듭니다. 프로세스에는 독점 eShopOnWeb 티켓 ID로 추적하도록 설계된 백로그 항목 필드가 포함됩니다.
...
9. **제품 백로그 항목에 필드 추가** 패널의 **정의** 탭에 있는 **필드 만들기** 섹션의 **이름** 텍스트 상자에 **EShop 티켓 ID**를 입력합니다.
    ...
    !["제품 백로그 항목에 필드 추가" 패널의 "정의" 탭의 "필드 만들기" 섹션의 "이름" 텍스트 상자에 "EShop 티켓 ID"를 입력합니다.](images/m1/EShop-WEB-pbi_v1.png)
...
11. **제품 백로그 항목에 필드 추가** 패널의 **레이아웃** 탭에 있는 **레이블** 텍스트 상자에 **티켓 ID**를 입력하고 **새 그룹 만들기** 옵션을 선택하고 **그룹** 텍스트 상자에 **EShopOnWeb**을 입력하고 **필드 추가**를 클릭합니다.
    ...
    > **참고**: 이제 사용자 지정된 프로세스가 구성되었으므로 이를 사용하도록 eShopOnWeb 프로젝트로 전환해 보겠습니다.
...
21. 이제 프로세스 사용자 지정 중에 정의된 **eShopOnWeb** 그룹 아래에 **티켓 ID** 필드가 있는지 확인합니다. 이 필드는 다른 텍스트 필드와 같은 방식으로 사용할 수 있습니다.

    ![이제 프로세스 사용자 지정 중에 정의된 "eShopOnWeb" 그룹 아래에 "티켓 ID" 필드가 있는지 확인합니다. 이 필드는 다른 텍스트 필드와 같은 방식으로 사용할 수 있습니다.](images/m1/EShop-WEB-verify_v1.png)
...
3. **대시보드** 창에서 **eShopOnWeb 팀 - 개요** 제목 옆에 있는 드롭다운 메뉴를 선택하고 **+ 새 dashboard** 선택합니다.
    ...
    !["대시보드" 창의 왼쪽 위 모서리에 있는 "eShopOnWeb Team" 섹션에서 "+ 새 dashboard"를 선택합니다.](images/m1/new_dashboard_v1.png)
