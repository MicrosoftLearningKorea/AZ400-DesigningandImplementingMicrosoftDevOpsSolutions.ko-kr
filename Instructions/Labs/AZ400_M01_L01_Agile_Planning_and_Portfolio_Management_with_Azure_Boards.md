...
11. Azure DevOps 포털의 세로 탐색 창에 있는 보드 항목 목록에서 **보드****를 선택합니다**.
12. 보드 패널에서 **EShop-WEB 보드** 항목을 선택합니다**.** 그러면 해당 특정 팀의 보드가 열립니다.

    ![ "보드>보드" 창에서 "EShop-WEB 보드"를 선택합니다.](images/m1/EShop-WEB-_boards_v1.png)

13. 보드 패널의 **오른쪽 위 모서리에서 백로그 항목** 항목을 선택하고 **드롭다운 목록에서 기능을** 선택합니다**.**

    > **참고**: 이렇게 하면 작업 및 기타 작업 항목을 기능에 쉽게 추가할 수 있습니다.

14. 학습 대시보드** 기능을 나타내는 사각형 위에 마우스 포인터를 **놓고 마우스로 가리킵니다. 그러면 오른쪽 위 모서리에 줄임표 기호(...)가 표시됩니다.
