...
### <a name="exercise-2-query-releaseinformation-via-restapi"></a>연습 2: REST API를 통해 릴리스 정보 쿼리
...
#### <a name="task-2-query-releaseinformation-via-restapi-by-using-postman"></a>작업 2: Postman을 사용하여 REST API를 통해 릴리스 정보 쿼리
