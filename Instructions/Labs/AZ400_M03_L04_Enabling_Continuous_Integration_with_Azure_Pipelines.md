...
이 작업에서는 정책을 기본 분기에 추가하고 정의된 정책을 준수하는 끌어오기 요청을 사용하여 변경만 허용합니다. 분기의 변경 내용을 병합하기 전에 해당 변경 내용을 검토하려 합니다.
...
5. 끌어오기 요청을 만들도록 제안하는 메시지가 팝업됩니다(**이제 Feature01** 분기가 **기본** 비해 변경 내용에서 앞서 있기 때문에). **끌어오기 요청 만들기**를 클릭합니다.
6. **새 끌어오기 요청** 탭에서 기본값은 그대로 두고 **만들기**를 클릭합니다.
7. 끌어오기 요청에는 대상 **기본** 분기에 적용된 정책에 따라 보류 중인 몇 가지 요구 사항이 표시됩니다.
